...
import { BrainCircuit, Loader2, Lock, Mail, ArrowRight, ChevronLeft, Eye, EyeOff } from "lucide-react";
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="block w-full pl-11 pr-12 py-3.5 bg-slate-50 dark:bg-[#1C1C1E] border-2 border-slate-200 dark:border-[#2C2C2E] rounded-xl text-sm focus:ring-0 focus:border-indigo-500 dark:focus:border-indigo-400 transition-colors dark:text-white"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
